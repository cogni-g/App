    ...
    switch (this.state.step) {
          ...
          <Card className='card'>
            ...
            <div className='btn'>
              <Button
                variant='contained'
                size='medium'
                disabled={this.state.gender === -1 || this.state.age === 0}
                onClick={() => {
          ...
          <Card className='card'>
            <div width='100%'>
              <div className='gender'>
                ...
                <div className='age'>{this.state.age} : גיל</div>
              </div>
              <div>
                ...
                <div className='iconHandler'>
                  ...
                  <IconButton
                    aria-label='delete'
                    size='medium'
                    color={this.state.btnSelect === 2 ? "primary" : "inherit"}
                    onClick={() => {
                      // earser
      ...
      case 3:
        return (
          <Card className='card'>
            <div width='100%'>
              <div className='title'>{this.state.tilte}</div>
              <div className='gender'>
                <div className='gen'>
                  מין : {this.state.gender ? "זכר" : "נקבה"}
                </div>
